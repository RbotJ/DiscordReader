...
def _process_quote(quote_data: Quote):
    ...
    try:
        ...
        if ask_price is not None and bid_price is not None:
            ...
            publish_price_update(symbol, mid_price)
...
def _process_bar(bar_data: Bar):
    ...
    try:
        ...
        publish_price_update(symbol, close_price)
...
def publish_price_update(symbol, price):
    publish_event(EventChannels.MARKET_PRICE_UPDATE, {'symbol': symbol, 'price': price})