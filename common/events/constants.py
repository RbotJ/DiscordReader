"""
Event Channel and Type Constants

Centralized event constants for the enhanced events system.
Moved from common/event_constants.py for better organization.
"""
